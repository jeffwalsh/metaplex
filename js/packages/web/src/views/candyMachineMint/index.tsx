...
export const CandyMachineMintView = () => {
  ...
  const cachedContent = {"program":{"uuid":"3UccZ1","config":"3UccZ1j5BQNLFdewUTFrq16Pd56777udACLgbLun3bke"},"name":"Jefftest","onChain":true}
